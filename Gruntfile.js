// Generated on 2014-06-30 using generator-angular-module 0.0.5
// jshint node: true
'use strict';
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    yeoman: {
      ...
      src: 'src',
      dist: 'dist',
      builtModule: 'angular-rickshaw.js',
      minifiedModule: 'angular-rickshaw.min.js'
    },
    ...
    clean: {
      dist: {
        files: [{
          ...
          src: [
            '.tmp',
            '<%= yeoman.dist %>/<%= yeoman.builtModule %>',
            '<%= yeoman.dist %>/<%= yeoman.minifiedModule %>'
          ]
        }]
      },
      server: '.tmp'
